 ...
 *
 * @since Kira Lite 1.0.3
 */
if( !class_exists('Kira_lite_Disabled_Custom_Control') ) {
	class Kira_lite_Disabled_Custom_Control extends WP_Customize_Control
	{
		...
		public function render_content()
		{
			...
			switch($this->type) {
				...
				case 'textarea':
					...
					echo '<span class="pro-badge">'.__('PRO', 'kira-lite').'</span>';
					?>
					<label>
